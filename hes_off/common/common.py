...
def run_command( Command ):
    """ runs os command with subprocess and checks for errors in command """
...
def file_length(fname):
    ...
    """ Calculate length (lines) of a data file, including headers """
...
def file_endread(fname):
    ...
    """ Calculate the end line to be read of a sensitivity .dat file from SU2 """
...
def read_history(fname, NZONE=1):

    """ Read history.dat and collect converged values """
...
def print_banner():
    ...
    """ Print the Parablade banner """

    print(r"###############################################################################################")
    print(r"#                    ____                 ____  _           _                                 #")
    print(r"#                   |  _ \ __ _ _ __ __ _| __ )| | __ _  __| | ___                            #")
    print(r"#                   | |_) / _` | '__/ _` |  _ \| |/ _` |/ _` |/ _ \                           #")
    print(r"#                   |  __/ (_| | | | (_| | |_) | | (_| | (_| |  __/                           #")
    print(r"#                   |_|   \__,_|_|  \__,_|____/|_|\__,_|\__,_|\___|                           #")
    print(r"#                                                                                             #")
    print(r"###############################################################################################")
    print('\n')
